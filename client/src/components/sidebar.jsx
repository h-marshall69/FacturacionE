function SideBar() {
  return (
    <>
      ...
      <aside class="w-72 bg-[#1c212c] min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
        {/*-- menu items --*/}
        <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
          ...
          <div className="w-full flex items-center gap-x-1.5 group select-none">
            ...
            >
              ...
              <span className="font-QuicksandMedium">Comprobante</span>
            </div>
          </div>
          ...
          <div className="w-full flex items-center gap-x-1.5 group select-none">
            ...
            >
              ...
              <span className="font-QuicksandMedium">Clientes</span>
            </div>
          </div>
          ...
          <div className="w-full flex items-center gap-x-1.5 group select-none">
            ...
            >
              ...
              <span className="font-QuicksandMedium">Productos</span>
            </div>
          </div>
